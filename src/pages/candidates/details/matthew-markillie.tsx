...
const candidateInfo = {
  ...
  image: '../../../images/photos-of-candidates/markille.jpeg'
}
...
const LandingPage: React.FC<PageProps> = () => {
  ...
  return <CandidatePage
    ...
    image={<StaticImage src='../../../images/photos-of-candidates/markille.jpeg' alt={`Photo of candidate`} width={128} aspectRatio={1} />}
  />
}
